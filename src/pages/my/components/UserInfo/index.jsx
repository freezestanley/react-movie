    ...
    <div className={style['me_userinfo']}>
      {
        user.userId ? (
          ...
          <div className={style['phone-info']}>
            <div className={style['phone']}>{phoneMask(user.userInfo.mobileNumber)}</div>
            {
             user.isVIP ?  <img className={style['baijinvip']} src={baijinvip} alt='vip'  onClick={() => router.push({pathname:'/vip'})} /> : <div className={style['gotomember']} onClick={() => router.push({pathname:'/vip'})}>开通会员<div className={style['rightarr']} /></div>
